    ...
    MODULE mesh_mod
      ...
      subroutine initMesh
        ...
        allocate( mesh%x        (      ips:ipe, jps:jpe, ifs:ife) )
        allocate( mesh%y        (      ips:ipe, jps:jpe, ifs:ife) )
        allocate( mesh%lon      (      ips:ipe, jps:jpe, ifs:ife) )
        allocate( mesh%lat      (      ips:ipe, jps:jpe, ifs:ife) )
        allocate( mesh%sqrtG    (      ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%matrixG  (2, 2, ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%matrixIG (2, 2, ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%matrixA  (2, 2, ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%matrixIA (2, 2, ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%f        (      ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%sinlon   (      ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%coslon   (      ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%sinlat   (      ips:ipe, ips:ipe, ifs:ife) )
        allocate( mesh%coslat   (      ips:ipe, ips:ipe, ifs:ife) )
