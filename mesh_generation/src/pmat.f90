...
!                                1993    *
!                                *  and Tsukasa Fujita, visiting
!                                scientist    *
!                                *  from JMA.
!                                *
!                                *  Major modifications: 2002, 2009,
!                                2012     *
!                                *  jim.purser@noaa.gov
!                                *
!                                *
...
! Originally, these routines were copies of the purely "inversion"
! members
! of pmat1.f90 (a most extensive collection of matrix routines -- not
! just
! inversions). As well as having both single and double precision
! versions
! of each routine, these versions also make provision for a more
! graceful
! termination in cases where the system matrix is detected to be 
! essentially singular (and therefore noninvertible). This provision
! takes
...
! that all the main matrix routines could be in the same library,
! pmat.a.
! 
! DIRECT DEPENDENCIES:
! Modules: pkind, pietc
...
!  <-> B    rt-hand-sides vectors on input, corresponding solutions on
!  return
!  --> IPIV array encoding the pivoting sequence
!=============================================================================
use pietc_s, only: u1
...
!  <-> B    right-hand-side vector on input, corresponding solution on
!  return
!  --> IPIV array encoding the pivoting sequence
!=============================================================================
use pietc_s, only: u1
