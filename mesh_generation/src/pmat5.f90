...
!
! DEPENDENCIES
! Modules:  pkind, pietc, pietc_s, pmat4
!=============================================================================
...
! Utility routines for orienting the globe and basic geographical
! mappings
!=============================================================================
module pmat5
!=============================================================================
...
!  earth-centered cartesian components to the alternative cartesian
!  frame      
!  oriented so as to put geographical point (ALAT0,ALON0) on the
!  projection    
!  axis.                                                                       
!=============================================================================
...
xe(1)=cla*clo; xe(2)=cla*slo; xe(3)=sla
dxedlat(1)=-sla*clo; dxedlat(2)=-sla*slo; dxedlat(3)=cla;
dxedlat=dxedlat*dtor
dxedlon(1)=-cla*slo; dxedlon(2)= cla*clo; dxedlon(3)=u0 ;
dxedlon=dxedlon*dtor
...
!==============================================================================
! From the degree lat and lo (plat and plon) return the standard
! orthogonal
...
! return its standard orthogonal cartesian frame, {xp,yp,zp} in
! earth-centered
! coordinates.
!=============================================================================
...
!==============================================================================
! Take a principal reference orthonormal frame, {xp,yp,zp} and a
! dependent
! point defined by unit vector, zv, and complete the V-frame cartesian
! components, {xv,yv}, that are the result of parallel-transport of
! {xp,yp}
...
!==============================================================================
! Given a principal cartesian orthonormal frame, {xp,yp,zp} (i.e., at P
! with
! Earth-centered cartesians, zp), and another similar frame {xv,yv,zv}
! at V
! with Earth-centered cartesians zv, find the relative rotation angle,
! "twist"
! by which the frame at V is rotated in the counterclockwise sense
! relative
! to the parallel-transportation of P's frame to V.
! Note that, by symmetry, transposing P and V leads to the opposite
! twist.
!==============================================================================
implicit none
...
!=============================================================================
!  Evaluate schmidt transformation, xc1 --> xc2, with scaling parameter
!  s
!=============================================================================
